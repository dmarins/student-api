...
// Source: internal/infrastructure/tracer/types.go
//
// Generated by this command:
//
//	mockgen -source=internal/infrastructure/tracer/types.go -destination=internal/domain/mocks/types.go -typed=true -package=mocks
//
